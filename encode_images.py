...
def main():
    ...
    parser.add_argument('--model_url', default='https://drive.google.com/uc?id=1-jbkbWlfjxMjtP_6jRYb-U4NiA6CWE03', help='Fetch a StyleGAN model to train on from this URL') # karras2019stylegan-ffhq-1024x1024.pkl
    ...
    if (args.use_lpips_loss > 0.00000001):
        with dnnlib.util.open_url('https://drive.google.com/uc?id=1NZ7dmfE494w94otsH72iInwt4aewVNzt', cache_dir=config.cache_dir) as f:
